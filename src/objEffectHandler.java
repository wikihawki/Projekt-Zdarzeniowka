	...
	case MONSTER:
		...
		case 40:
		{
			...
			if(player!=target){
				...
				int temp=JOptionPane.showOptionDialog(null, massage, "Wybierz któr¹ karte chcesz zabrac", 0, JOptionPane.QUESTION_MESSAGE, null, ((objPlayer)target).getHand().toArray(), 0);
